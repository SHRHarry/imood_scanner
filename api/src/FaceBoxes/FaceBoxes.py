...
from api.src.FaceBoxes.utils.prior_box import PriorBox
from api.src.FaceBoxes.utils.nms_wrapper import nms
from api.src.FaceBoxes.utils.box_utils import decode
from api.src.FaceBoxes.utils.timer import Timer
from api.src.FaceBoxes.utils.functions import check_keys, remove_prefix, load_model
from api.src.FaceBoxes.utils.config import cfg
from api.src.FaceBoxes.models.faceboxes import FaceBoxesNet
...
def main():
    ...
    img_fp = osp.join(r"D:\iMood_scanner_data\RAF-DB_Basic_emotion\Image\original", fn)
